package fr.acore.bungeecord.storage.table;

import fr.acore.bungeecord.api.storage.column.IColumn;
import fr.acore.bungeecord.api.storage.column.foreign.ManyToOne;
import fr.acore.bungeecord.api.storage.column.foreign.ModificationConstraintType;
...
import fr.acore.bungeecord.api.storage.constraint.query.by.IByConstraint;
...
import fr.acore.bungeecord.storage.DBHelper;
import fr.acore.bungeecord.storage.constraint.QueryConstraint;
import fr.acore.bungeecord.storage.constraint.query.QueryColumnConstraint;
import fr.acore.bungeecord.storage.table.utils.AutoIncrement;
